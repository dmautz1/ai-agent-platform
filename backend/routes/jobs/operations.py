        ...
        try:
            ...
            return {
                ...
                "retry_job": {
                    ...
                    "agent_identifier": new_job["agent_identifier"]
                },
                "timestamp": datetime.now(timezone.utc).isoformat()
            }
...
async def cancel_job(
    ...
    """
    with perf_logger.time_operation("cancel_job", user_id=user["id"], job_id=job_id):
...
async def update_job_priority(
    ...
    with perf_logger.time_operation("update_job_priority", user_id=user["id"], job_id=job_id):
        logger.info(
