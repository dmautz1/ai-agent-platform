...
Provides DeepSeek integration for AI agent functionality.
...
class DeepSeekService:
    """Service providing DeepSeek functionality for agents via composition"""
    
    def __init__(self):
        self._deepseek_config = get_deepseek_config()
    ...
    @monitor_connection_health("DeepSeek")
    async def query(
        self, 
        prompt: str, 
        ...
        **kwargs
        ...
        """
        Simple LLM query using DeepSeek API
        ...
        try:
            model_name = safe_model_selection(
                ...
                available_models=self._deepseek_config.get_available_models(),
                default_model=self._deepseek_config.default_model,
            ...
            raise handle_llm_query_error("DeepSeek", e)
        ...
        **kwargs
        ...
        for attempt in range(max_retries + 1):
            try:
                ...
                error_result = handle_structured_query_retry_error("DeepSeek", e, attempt, max_retries, output_schema)
    ...
    async def batch_query(
        ...
        **kwargs
        ...
        try:
            ...
            logger.error(f"DeepSeek batch execution failed: {e}")
    ...
    def get_info(self) -> Dict[str, Any]:
        """Get information about the DeepSeek service configuration"""
        return {
            "service": "DeepSeek",
    ...
    def get_health_status(self) -> Dict[str, Any]:
        """Get connection health status for the DeepSeek service"""
        tracker = get_health_tracker("DeepSeek")
    ...
    def test_connection(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "service": "DeepSeek",
                "provider": "DeepSeek",
                "model": self._deepseek_config.default_model,
                "base_url": self._deepseek_config.base_url
            }
        except Exception as e:
            return {
