...
Provides Grok (xAI) integration for AI agent functionality.
Follows the same interface pattern as GoogleAIService and OpenAIService for consistency.
"""
...
class GrokService:
    """Service providing Grok (xAI) functionality for agents via composition"""
    
    def __init__(self):
        self._grok_config = get_grok_config()
        # Grok uses OpenAI-compatible API with custom base URL
        self._client = openai.AsyncOpenAI(
            api_key=self._grok_config.api_key,
            base_url=self._grok_config.base_url
        )
        logger.info("Grok service initialized")
    
    # Core LLM Operations
    
    @monitor_connection_health("Grok")
    async def query(
        self, 
        prompt: str, 
        ...
        **kwargs
        ...
        """
        Simple LLM query using Grok API
        ...
        try:
            model_name = safe_model_selection(
                ...
                available_models=self._grok_config.get_available_models(),
                default_model=self._grok_config.default_model,
            ...
            raise handle_llm_query_error("Grok", e)
        ...
        **kwargs
        ...
        for attempt in range(max_retries + 1):
            try:
                ...
                error_result = handle_structured_query_retry_error("Grok", e, attempt, max_retries, output_schema)
    ...
    async def batch_query(
        ...
        **kwargs
        ...
        try:
            ...
            logger.error(f"Grok batch execution failed: {e}")
    ...
    def get_info(self) -> Dict[str, Any]:
        """Get information about the Grok service configuration"""
        return {
            "service": "Grok",
    ...
    def get_health_status(self) -> Dict[str, Any]:
        """Get connection health status for the Grok service"""
        tracker = get_health_tracker("Grok")
    ...
    def test_connection(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "service": "Grok",
                "provider": "xAI",
                "model": self._grok_config.default_model,
                "base_url": self._grok_config.base_url
            }
        except Exception as e:
            return {
...
def get_grok_service() -> GrokService:
    """Get the global Grok service instance"""
